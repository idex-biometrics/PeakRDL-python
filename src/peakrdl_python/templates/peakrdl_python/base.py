...
class Base:
    ...
    __slots__ : List[str] = ['__parent', '__logger', '__inst_name']
    ...
    @property
    def full_name(self, separator=".") -> str:
        """
        Returns the full hierarchical path to the item e.g.
        """
        return_name = self.inst_name
        p = self.parent
        while p is not None :
            return_name = p.inst_name + separator + return_name
            p = p.parent
